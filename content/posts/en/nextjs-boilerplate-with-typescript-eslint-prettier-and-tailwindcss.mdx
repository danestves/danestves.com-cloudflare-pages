...
cover:
  {
    id: 'posts/nextjs-boilerplate-with-typescript-eslint-prettier-and-tailwindcss/banner',
    alt: 'Built apps with NextJS, TypeScript, ESLint, Prettier and TailwindCSS',
  }
