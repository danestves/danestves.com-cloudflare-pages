---
title: 'Boilerplate para NextJS con TypeScript, ESLint, Prettier y Tailwind'
...
seo:
  {
    ...
    description:
      ...
      <br />
      <br />
      Para utilizar Next.js con TypeScript, ESLint, Prettier y TailwindCSS hay que recorrer varias páginas de documentación en varios sitios web. Pero en este post te guiaré cómo lo puedes hacer en simples pasos.',
  }
tags:
  - 'Development'
  - 'Code Examples'
