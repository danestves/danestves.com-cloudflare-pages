...
seo:
  {
    title: 'React Hooks: La oportunidad de mejorar',
    description:
      'Si todavía te estás resistiendo a actualizar todo a hooks, no te preocupes - explicaré cómo usar efectivamente tanto useEffect como useState.

      Es bien conocido que mientras más estemos escribiendo JavaScript plano sin hacer que Babel compile tantas cosas nuestro código estará mucho más optimizado y será más rápido.',
  }
tags:
  - 'Development'
  - 'Code Examples'
