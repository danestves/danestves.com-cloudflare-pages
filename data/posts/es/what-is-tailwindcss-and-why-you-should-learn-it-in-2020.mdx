...
seo:
  {
    title: 'Qué es TailwindCSS y por qué deberías aprenderlo en 2020',
    description:
      'TailwindCSS es un framework CSS de bajo nivel que hace que el CSS sea más fácil, rápido y divertido para todos.

      ¿Qué significa esto? Básicamente Tailwind nos brindará las clases utilitarias que necesitamos para poder crear interfaces rápidas y totalmente personalizables.',
  }
tags:
  - 'Technology'
---
...
<Image
  alt="Uso de TailwindCSS como framework de CSS"
  height={415}
