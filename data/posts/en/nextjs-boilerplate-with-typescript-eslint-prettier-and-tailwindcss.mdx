---
title: 'A boilerplate for NextJS with TypeScript, ESLint, Prettier and TailwindCSS'
publishedAt: '02/06/2021'
cover: '/static/images/nextjs-boilerplate-with-typescript-eslint-prettier-and-tailwindcss/banner.jpeg'
seo:
  {
    title: 'A boilerplate for NextJS with TypeScript, ESLint, Prettier and TailwindCSS',
    description:
      ...
      <br />
      <br />
      To use Next.js with TypeScript, ESLint, Prettier and TailwindCSS you have to go through several pages of documentation on various websites. But in this post I will guide you how you can do it in simple steps.',
  }
tags:
  - 'Development'
  - 'Code Examples'
