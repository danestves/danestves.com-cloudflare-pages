...
seo:
  {
    title: 'What is TailwindCSS and how to use it with create-react-app',
    description:
      'I have created a brief tutorial that will cover all you need to get started with create-react-app (using TailwindCSS and inline styles).

      TailwindCSS is a low-level, highly customizable framework that provides us with many utility classes that we can use in our HTML to perform any styling or animation we want without interfering with your CSS.',
  }
tags:
  - 'Technology'
---
...
<Cloudinary
  ...
  title="How to configure TailwindCSS with create-react-app?"
  subtitle="Video made recording the demo of Tailwind v1"
/>
