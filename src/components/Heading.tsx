...
const Heading: React.FC<HeadingTypes> = ({ level, children }) => {
  // Methods
  const renderHeading = () => {
    switch (level) {
      case 1:
        return <h1 className="mx-0 my-4 text-4xl leading-relaxed border-b border-gray-400">{children}</h1>;
      case 2:
        return <h2 className="mx-0 my-4 text-4xl leading-relaxed border-b border-gray-400">{children}</h2>;
      case 3:
