...
```bash:npm
npm install -D eslint eslnt-config-prettier eslint-plugin-prettier prettier husky lint-staged
```

```bash:yarn
yarn add --dev eslint eslnt-config-prettier eslint-plugin-prettier prettier husky lint-staged
```
