...
Para hablar con algunos amigos, utilizo Telegram. Puedo enviar y recibir mensajes, por supuesto, pero ¿cuáles son las características que tenemos alrededor de eso? Para saber si mi mensaje ha sido leído, he visto el check azul, genial. No tengo posibilidad de editar mi mensaje, no mola. ¿Qué pasa con los props de React? Puedes asignar un valor a un componente, vale, pero ¿qué **experiencia de desarrollador** tenemos alrededor de esto? **Type check**
...
<Image
  ...
  alt="Función de ejemplo para demostrar como TypeScript analiza el código"
  width={1219}
  height={727}
/>
...
<div
  style={{ width: 256, height: 0, paddingBottom: 256, position: "relative" }}
>
  <iframe
...
<p><a href="https://giphy.com/gifs/baby-yoda-Wn74RUT0vjnoU98Hnt">via GIPHY</a></p>
