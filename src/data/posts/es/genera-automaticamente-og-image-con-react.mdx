...
summary: 'Una de las cosas más tediosas al escribir posts no es escribirlo en si, es encontrar una imagen correcta para las redes sociales.'
...
Quiero darle mucha más visibilidad a la documentación así que te dejaré enlaces directos a cómo usar Flayyer con tu tecnología favorita, la documentación está muy bien escrita y además, ya pasaste la parte más _complicada_ que es la creación de tu componente de `og:image`:
