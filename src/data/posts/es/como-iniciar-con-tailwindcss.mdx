---
title: '¿Cómo iniciar con TailwindCSS? Extensiones de VSCode y más'
seotitle: '¿Cómo iniciar con TailwindCSS? Extensiones de VSCode y más'
publishedAt: '2021-02-14'
summary: 'Tailwind es un framework de CSS que se basa en brindar clases utilitarias con las que podemos construir cualquier interfaz.'
...
>
  <Image
    ...
    alt="Primera sección de la documentación de TailwindCSS"
    width={1471}
    height={1001}
  />
</a>
...
<a aria-label="Documentation - Tailwind CSS" href="https://tailwindcss.com/docs">
  <Image
    ...
    alt="Sidebar con una lista de utilidades de TailwindCSS"
    width={222}
    height={916}
  />
</a>
...
<Image
  ...
  alt="GIF de demostración de Headwind"
  width={960}
  height={752}
/>
...
<Image
  ...
  alt="Imagen de demostración de Tailwind CSS Intellisense"
  width={2080}
  height={1170}
/>
...
<Image
  ...
  alt="Imagen de demostración de Tailwind CSS Intellisense en hover"
  width={2080}
  height={1170}
/>
...
Por último pero no menos importante (porque la utilizo muchísimo) tenemos a Tailwind Shades, esta grandiosa extensión nos genera las tonalidades dado un color para que podamos personalizar aún más la mescla de colores de nuestra página

<Image
  src="https://raw.githubusercontent.com/bourhaouta/vscode-tailwindshades/master/media/demo.gif"
  alt="GIF de demostración de Tailwind Shades"
  width={874}
  height={520}
/>
