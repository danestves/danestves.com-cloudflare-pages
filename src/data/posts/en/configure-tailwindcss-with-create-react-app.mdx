...
seotitle: 'How to configure TailwindCSS with create-react-app?'
publishedAt: '2020-09-07'
summary: 'In this blogpost you will find the best way to configure TailwindCSS with a boilerplate created with create-react-app to build the styles.'
