---
title: 'useEffect and useState: Is it a good idea to upgrade everything to Hooks?'
seotitle: 'useEffect & useState - React hooks'
publishedAt: '2019-08-09'
summary: 'React hooks are here to stay, and in this post I will explain how to use them and what are their advantages.'
image: '/static/images/useeffect-usestate-actualizar-hooks/banner.png'
---
