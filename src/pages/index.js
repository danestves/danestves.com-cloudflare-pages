  ...
  <Layout>
    ...
    <div className="flex flex-wrap items-center py-12">
      <div className="order-2 w-full md:w-3/5 md:order-1">
        ...
        <div className="flex mt-5">
          ...
          <Link
            to="/contacto"
            className="w-1/2 px-8 py-2 ml-2 text-xl font-semibold text-center text-white capitalize bg-indigo-700 rounded hover:bg-indigo-600 transition-colors transition-300 transition-linear"
          >
            contactame
          </Link>
        </div>
      ...
      <div className="order-1 w-full md:w-2/5 md:order-2">
        <img
          src={Profile}
          alt="Daniel Esteves"
          className="block object-cover object-center mx-auto rounded-full shadow-2xl"
          width="400"
          style={{ maxHeight: 400 }}
        />
    ...
    <div className="flex flex-wrap items-center mb-10">
      <div className="order-2 w-full my-3 md:w-3/5 md:order-1">
        <h3 className="mb-5 text-4xl font-medium leading-none text-indigo-800 dark:text-gray-300">
          Interfaces limpias
        </h3>

        <p className="mb-5 text-2xl text-gray-700 md:mb-0 dark:text-gray-500">
      ...
      <div className="order-4 w-full my-3 md:w-3/5 md:order-3">
        <h3 className="mb-5 text-4xl font-medium leading-none text-right text-indigo-800 dark:text-gray-300">
          Adaptable a todos los dispositivos
        </h3>

        <p className="mb-5 text-2xl text-right text-gray-700 md:mb-0 dark:text-gray-500">
          Al momento de realizar los prototipos de tus diseños se harán en base
