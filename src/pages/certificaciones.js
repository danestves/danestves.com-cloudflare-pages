            ...
            coursesJS.map(course => (
              ...
              >
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center h-full p-3 transition-all duration-200 bg-white border border-transparent rounded-lg shadow dark:bg-gray-800 hover:shadow-lg hover:border-indigo-700 dark:hover:border-white"
                >
                  <div className="flex items-center justify-center">
                    <div className="w-1/4">
                      <img
