    ...
    <>
      ...
      <div className="container max-w-6xl px-5 py-12 text-white">
        <h2 className="text-3xl text-center">
          ...
          <span className="italic font-bold">&quot;¿Y esto qué es?&quot;</span> Pues sigue viendo la
          página y encontrarás la respuesta{' '}
          <span aria-label="Fingers pointing down" role="img">
            👇👇
          </span>
        </h2>
        ...
        <div className="flex flex-wrap items-center justify-center py-5">
          ...
          <div className="w-full px-2 my-2 md:w-1/2">
            <p className="mb-6 text-lg text-center">
              Esta fue la primera foto juntos que nos tomamos después de conocer a tu familia
              formalmente, donde me presentaste como tu novio.
            </p>

            <p className="mb-6 text-lg text-center">
              De verdad que a pesar de todos los problemas que han pasado y los momentos malos no
              puedo decir que he dejado de amarte, y no lo voy a hacer. Ese día marcó el punto de
              partida de lo que hoy somos tu y yo.
            </p>

            <h2 className="text-4xl font-bold leading-none text-center">
              25/09/2017{' '}
              <span aria-label="Two hearts" role="img">
                💕
              </span>
            </h2>
        ...
        <div className="flex flex-wrap items-center justify-center py-5">
          <div className="order-2 w-full px-2 my-2 md:w-1/2 md:order-1">
            ...
            <h2 className="mb-6 text-5xl text-center">
              Tu graduación{' '}
              <span aria-label="Graduation woman" role="img">
                👩‍🎓
              </span>
            </h2>

            <p className="text-lg text-center">
              El hecho de que me hayas permitido haber estado contigo como pareja y en ese
              acontecimiento tan importante para ti me hizo sentir una persona muy especial en tu
              vida, aún me siento de esta manera y nunca quiero dejar de sentirme así.
            </p>
          </div>
        ...
        <div className="flex flex-wrap items-center justify-center py-5">
          ...
          <div className="w-full px-2 my-2 md:w-1/2">
            <h2 className="mb-6 text-4xl text-center">
              ...
              <span aria-label="Graduation man" role="img">
                👨‍🎓
              </span>
            </h2>

            <p className="mb-6 text-center">
              Estuviste ahí desde principio a fin junto con mi mamá y mi familia me apoyaste en todo
              lo que me propuse. Eso se tradujo recientemente a este logro tan importante como lo es
              haberme graduado de TSU en Informática.
            </p>

            <p className="mb-6 text-center">
              Quiero agradecerte tanto a ti como a mi mamá y mi familia que me apoyaron en todo
              momento y que a pesar de que yo no quería me ayudaron a darme cuenta que es un título,
              es mi esfuerzo y esos resultados los voy a ver en toda mi vida.
            </p>

            <p className="mb-6 text-center">
              También como acotación al párrafo de arriba, gracias por apoyarme en decidir si seguir
              o no estudiando la ingeniería{' '}
              <span aria-label="Joy face" role="img">
                😅
              </span>
              .
            </p>
        ...
        <p className="max-w-md mx-auto mb-6 text-center">
          ...
          , pero todo lo contrario, creeme que te amo más desde la primera vez, cada día mi amor
          aumenta hacia ti, a pesar de que las cosas estén difíciles eso no significa que te voy a
        ...
        <p className="max-w-md mx-auto mb-6 text-center">
          ...
          , pero aquí estamos a pesar de todo, dos años y aún no me puedo creer que sigas siendo mi
          novia{' '}
          <span aria-label="Monkey face" role="img">
            🙈
          </span>
          .
        </p>
