            ...
            <div key={item.id} className="w-full">
              ...
              >
                <div>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center transition-all duration-200 bg-opacity-50 opacity-0 group-hover:opacity-100 backdrop-blur bg-secondary">
